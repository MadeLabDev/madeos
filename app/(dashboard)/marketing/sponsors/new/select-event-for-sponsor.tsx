...
interface SelectEventForSponsorProps {
	onEventSelected: (event: Event) => void;
}

export function SelectEventForSponsor({ onEventSelected }: SelectEventForSponsorProps) {
	...
	return (
		<div className="space-y-6">
			{/* Header */}
			<div>
				<h1 className="text-3xl font-bold tracking-tight">Create Sponsor Material</h1>
				<p className="text-muted-foreground">Select an event to create sponsor material for</p>
			</div>
