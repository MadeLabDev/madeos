...
import { createMarketingCampaignAction } from "@/lib/features/marketing/actions";
...
export function NewCampaignForm() {
	...
	const onSubmit = async (data: CampaignFormData) => {
		...
		try {
			const result = await createMarketingCampaignAction(data);
		...
		<div className="space-y-6">
			<div className="flex items-center justify-between gap-4">
				<div>
					...
					<p className="text-muted-foreground mt-1">Set up a new marketing campaign to reach your audience</p>
				</div>
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>Fill in the basic information for your marketing campaign</CardDescription>
				</CardHeader>
				<CardContent>
					<Form {...form}>
						<form
