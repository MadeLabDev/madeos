...
export function NewTrainingEngagementForm() {
	...
	return (
		<div className="space-y-6">
			...
			<div className="flex items-center justify-between gap-4">
				<div>
					<h1 className="text-3xl font-bold tracking-tight">Create New Training Engagement</h1>
					<p className="text-muted-foreground">Create a new training engagement with sessions and assessments</p>
				</div>
			...
			{/* Form */}
			<TrainingEngagementForm hideButtons={true} />
		</div>
	);
}
