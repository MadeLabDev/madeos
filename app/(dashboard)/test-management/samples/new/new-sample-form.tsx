...
export function NewSampleForm() {
	...
	function handleCancel() {
		router.push("/test-management/samples");
	}
	...
	return (
		<div className="space-y-6">
			...
			<div className="flex items-center justify-between gap-4">
				<div>
					<h1 className="text-3xl font-bold tracking-tight">Create Sample</h1>
					<p className="text-muted-foreground">Create a new sample for testing</p>
				</div>
