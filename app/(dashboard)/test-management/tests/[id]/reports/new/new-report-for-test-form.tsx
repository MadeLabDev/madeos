...
interface NewReportForTestFormProps {
	testId: string;
}

export function NewReportForTestForm({ testId }: NewReportForTestFormProps) {
		...
		<div className="space-y-6">
			...
			<div className="flex items-center justify-between gap-4">
				<div>
					...
					<p className="text-muted-foreground">Create a new test report for this test</p>
				</div>
