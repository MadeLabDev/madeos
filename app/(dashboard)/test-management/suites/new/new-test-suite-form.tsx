...
export function NewTestSuiteForm() {
	const router = useRouter();
	const [isSubmitting, setIsSubmitting] = useState(false);

	function handleCancel() {
		router.push("/test-management/suites");
	}
	...
	return (
		<div className="space-y-6">
			...
			<div className="flex items-center justify-between gap-4">
				<div>
					<h1 className="text-3xl font-bold tracking-tight">Create Test Suite</h1>
					<p className="text-muted-foreground">Create a new test suite with standardized test templates</p>
				</div>
			...
			{/* Form */}
			<TestSuiteForm hideButtons={true} />
		</div>
	);
}
