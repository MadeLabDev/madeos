...
interface NewTestForSuiteFormProps {
	suiteId: string;
}

export function NewTestForSuiteForm({ suiteId }: NewTestForSuiteFormProps) {
		...
		<div className="space-y-6">
			...
			<div className="flex items-center justify-between gap-4">
				<div>
					...
					<p className="text-muted-foreground">Create a new test for this test suite</p>
				</div>
