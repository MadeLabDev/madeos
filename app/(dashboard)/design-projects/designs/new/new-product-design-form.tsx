...
export function NewProductDesignForm() {
	const router = useRouter();
	const [isSubmitting, setIsSubmitting] = useState(false);

	function handleCancel() {
		router.push("/design-projects/designs");
	}
	...
	return (
		<div className="space-y-6">
			...
			<div className="flex items-center justify-between gap-4">
				<div>
					<h1 className="text-3xl font-bold tracking-tight">Create Product Design</h1>
					<p className="text-muted-foreground">Create a new product design for a design project</p>
				</div>
