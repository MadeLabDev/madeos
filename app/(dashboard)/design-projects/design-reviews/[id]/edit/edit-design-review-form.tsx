...
interface EditDesignReviewFormProps {
	id: string;
}

export function EditDesignReviewForm({ id }: EditDesignReviewFormProps) {
	...
	return (
		<div className="space-y-6">
			...
			<div className="flex items-center justify-between gap-4">
				<div>
					<h1 className="text-3xl font-bold tracking-tight">Edit Design Review</h1>
					<p className="text-muted-foreground">Update design review information and feedback</p>
				</div>
