...
interface EditDesignDeckFormProps {
	id: string;
}

export function EditDesignDeckForm({ id }: EditDesignDeckFormProps) {
	...
	return (
		<div className="space-y-6">
			...
			<div className="flex items-center justify-between gap-4">
				<div>
					<h1 className="text-3xl font-bold tracking-tight">Edit Design Deck</h1>
					<p className="text-muted-foreground">Update design deck information and settings</p>
				</div>
