...
import { TagDetailWrapperProps } from "@/lib/features/knowledge-tags";
import { useChannelEvent, usePusher } from "@/lib/hooks/use-pusher";

export function TagDetailWrapper({ tagId, initialTag }: TagDetailWrapperProps) {
			...
			<div className="space-y-6">
				...
				<div className="flex items-center justify-between">
					...
					<div className="flex gap-2">
						<Link href={`/knowledge/tags/${tagId}/edit`}>
							<Button>
					...
					<CardContent className="space-y-6">
						...
						{tag.description && (
							<div>
								...
								<p className="mt-2 text-sm leading-relaxed">{tag.description}</p>
							</div>
						)}
