...
import { DemoAccountsPanel } from "@/components/dev";
	...
	return (
		<div className="bg-background flex min-h-screen items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
			<div className="w-full max-w-md space-y-8">
				<div>
					<h2 className="text-foreground mt-6 text-center text-3xl font-extrabold">Sign in to your account</h2>
				</div>

				<div className="bg-card border-border space-y-6 rounded-lg border px-6 py-8 shadow">
					{error && (
						<div className="bg-error/10 rounded-md p-3">
						...
						<>
							...
							<div>
								<button
									...
									disabled={loading}
									className="border-input bg-background text-foreground hover:bg-muted focus:ring-ring inline-flex w-full justify-center rounded-md border px-4 py-2 text-sm font-medium shadow-sm transition-colors focus:ring-2 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50">
									<svg
										className="h-5 w-5"
										viewBox="0 0 24 24">
										<path
          ...
          <Link href="/auth/activate" className="font-medium text-primary hover:text-primary/80">
