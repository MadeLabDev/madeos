import { $convertFromMarkdownString, $convertToMarkdownString, CHECK_LIST, ELEMENT_TRANSFORMERS, ElementTransformer, MULTILINE_ELEMENT_TRANSFORMERS, TEXT_FORMAT_TRANSFORMERS, TEXT_MATCH_TRANSFORMERS } from "@lexical/markdown";
...
export const TABLE: ElementTransformer = {
	...
	replace: (parentNode, _1, match) => {
		// Guard: ensure match is defined before accessing match[0]
		if (!match || !match[0]) {
			return;
		}
