...
import { $getSelection, $isLineBreakNode, $isNodeSelection, $isRangeSelection, BaseSelection, CLICK_COMMAND, COMMAND_PRIORITY_CRITICAL, COMMAND_PRIORITY_HIGH, COMMAND_PRIORITY_LOW, KEY_ESCAPE_COMMAND, LexicalEditor, SELECTION_CHANGE_COMMAND } from "lexical";
...
function FloatingLinkEditor({ editor, isLink, setIsLink, anchorElem, isLinkEditMode, setIsLinkEditMode }: { editor: LexicalEditor; isLink: boolean; setIsLink: Dispatch<boolean>; anchorElem: HTMLElement; isLinkEditMode: boolean; setIsLinkEditMode: Dispatch<boolean> }): JSX.Element {
	...
	return (
		<div
			ref={editorRef}
			className="bg-background absolute top-0 left-0 w-full max-w-sm rounded-md border-0 opacity-0 shadow-md">
...
export function FloatingLinkEditorPlugin({ anchorElem, isLinkEditMode, setIsLinkEditMode }: { anchorElem: HTMLDivElement | null; isLinkEditMode: boolean; setIsLinkEditMode: Dispatch<boolean> }): JSX.Element | null {
