...
const maxLength = Infinity; // Unlimited character length
...
export function Plugins({}) {
	...
	return (
		<div className="relative">
			<ToolbarPlugin>
				{({ blockType }) => (
					<div className="sticky top-0 z-10 border-b">
						{/* Row 1: History, Block Format, and Font Tools */}
						<div className="vertical-align-middle flex items-center gap-2 overflow-auto border-b p-1">
						...
						{/* Row 2: Formatting and Insert Tools */}
						{blockType !== "code" && (
							<div className="vertical-align-middle flex items-center gap-2 overflow-auto p-1">
			...
			<div className="relative focus:border-0! focus:outline-none!">
				<AutoFocusPlugin />
				<RichTextPlugin
					contentEditable={
						<div className="focus:border-0! focus:outline-none!">
							<div
								className="focus:border-0! focus:outline-none!"
								ref={onRef}>
								<ContentEditable
									placeholder={placeholder}
									className="ContentEditable__root relative block max-h-[60vh] min-h-72 overflow-auto px-8 py-4 focus:border-0! focus:outline-none!"
								/>
							</div>
						</div>
					}
				...
				<ComponentPickerMenuPlugin
					baseOptions={[ParagraphPickerPlugin(), HeadingPickerPlugin({ n: 1 }), HeadingPickerPlugin({ n: 2 }), HeadingPickerPlugin({ n: 3 }), TablePickerPlugin(), CheckListPickerPlugin(), NumberedListPickerPlugin(), BulletedListPickerPlugin(), QuotePickerPlugin(), CodePickerPlugin(), DividerPickerPlugin(), EmbedsPickerPlugin({ embed: "tweet" }), EmbedsPickerPlugin({ embed: "youtube-video" }), ImagePickerPlugin(), ColumnsLayoutPickerPlugin(), AlignmentPickerPlugin({ alignment: "left" }), AlignmentPickerPlugin({ alignment: "center" }), AlignmentPickerPlugin({ alignment: "right" }), AlignmentPickerPlugin({ alignment: "justify" })]}
				...
				<div className="clear-both flex items-center justify-between gap-2 overflow-auto border-t p-1">
					...
					<div className="flex flex-1 justify-end">
						...
						<MarkdownTogglePlugin
							...
							transformers={[TABLE, HR, IMAGE, EMOJI, TWEET, CHECK_LIST, ...ELEMENT_TRANSFORMERS, ...MULTILINE_ELEMENT_TRANSFORMERS, ...TEXT_FORMAT_TRANSFORMERS, ...TEXT_MATCH_TRANSFORMERS]}
						/>
